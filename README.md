...
- Operators that build the expression as readable text rather than computing immediately, e.g. typing `8%` shows `8%` and previews `0.08`; `8` then `x²` shows `8^(2)`; `8` then `√` shows `√(8`
